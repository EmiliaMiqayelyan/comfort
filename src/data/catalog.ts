...
export const products: Product[] = [
  {
    ...
    images: [img.product, img.hero1, img.living],
    height: 80,
    width: 16,
    depth: 16,
    length: 2400,
  ...
  },
  {
    ...
    collectionId: "col-classic",
    images: [img.product, img.classic],
    height: 45,
    width: 20,
    depth: 20,
    length: 2400,
  ...
  },
  {
    ...
    slug: "plinth-modern",
    sku: "MD-070",
    name: L("Plinth Modern", "Плинтус Modern", "Սալիկ Modern"),
    description: L(
      "A simple rectangular block profile for contemporary interiors.",
      "Простой прямоугольный профиль для современных интерьеров.",
      "Պարզ ուղղանկյուն պրոֆիլ ժամանակակից ինտերիերի համար։",
    ),
    categoryId: "cat-baseboards",
    collectionId: "col-modern",
    images: [img.product, img.hero1],
    ...
    textures,
    specs: [
      { key: "height", label: L("Height", "Высота", "Բարձրություն"), value: "70", unit: "mm" },
    ],
    downloads: [],
    price: 4100,
    featured: true,
  ...
  },
  {
    ...
    slug: "plinth-elegant",
    sku: "EL-090",
    name: L("Plinth Elegant", "Плинтус Elegant", "Սալիկ Elegant"),
    description: L(
      "A profile with a smooth convex top curve.",
      "Профиль с мягкой выпуклой верхней линией.",
      "Պրոֆիլ փափուկ ուռուցիկ վերին գծով։",
    ),
    categoryId: "cat-baseboards",
    collectionId: "col-classic",
    images: [img.product, img.hero2],
    ...
    textures,
    specs: [
      { key: "height", label: L("Height", "Высота", "Բարձրություն"), value: "90", unit: "mm" },
    ],
    downloads: [],
    price: 4500,
    availability: "in_stock",
  ...
  {
    id: "p-molding-classic",
    slug: "molding-classic",
    sku: "ML-CL",
    name: L("Molding Classic", "Молдинг Classic", "Մոլդինգ Classic"),
    description: L(
      "Elaborate decorative molding with multiple ridges.",
      "Декоративный молдинг с классическими линиями.",
      "Դեկորատիվ մոլդինգ դասական գծերով։",
    ),
    categoryId: "cat-moldings",
    collectionId: "col-classic",
    images: [img.product, img.classic],
    ...
    textures,
    specs: [
      { key: "height", label: L("Height", "Высота", "Բարձրություն"), value: "50", unit: "mm" },
    ],
    downloads: [],
    price: 3400,
    availability: "in_stock",
  },
  {
    ...
    slug: "molding-modern",
    sku: "ML-MD",
    name: L("Molding Modern", "Молдинг Modern", "Մոլդինգ Modern"),
    description: L(
      "Stepped geometric profile with sharp lines.",
      "Геометрический профиль с чёткими линиями.",
      "Երկրաչափական պրոֆիլ հստակ գծերով։",
    ),
    categoryId: "cat-moldings",
    collectionId: "col-modern",
    images: [img.product, img.modern],
    height: 40,
    width: 18,
    depth: 18,
    length: 2400,
    ...
    textures,
    specs: [
      { key: "height", label: L("Height", "Высота", "Բարձրություն"), value: "40", unit: "mm" },
    ],
    downloads: [],
    price: 3100,
    availability: "in_stock",
  },
  {
    ...
    slug: "molding-flat",
    sku: "ML-FL",
    name: L("Molding Flat", "Молдинг Flat", "Մոլդինգ Flat"),
    description: L(
      "A simple beveled profile for quiet detailing.",
      "Простой скошенный профиль для лаконичных деталей.",
      "Պարզ թեք պրոֆիլ հանգիստ դետալների համար։",
    ),
    categoryId: "cat-moldings",
    collectionId: "col-minimal",
    images: [img.product, img.minimal],
    height: 28,
    width: 14,
    depth: 14,
    length: 2400,
    ...
    textures,
    specs: [
      { key: "height", label: L("Height", "Высота", "Բարձրություն"), value: "28", unit: "mm" },
    ],
    downloads: [],
    price: 2800,
    availability: "in_stock",
