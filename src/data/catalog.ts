...
export const categories: ProductCategory[] = [
  ...
  },
  {
    id: "cat-panels",
    slug: "wall-panels",
    name: L("Pannels", "Панели", "Վահանակներ"),
    description: L(
  ...
  },
  {
    id: "cat-3d-prof",
    slug: "3d-prof",
    name: L("3D Prof", "3D Prof", "3D Prof"),
    description: L(
      "3D professional wall panel profiles.",
      "Профессиональные 3D панели.",
      "3D պրոֆեսիոնալ պատի վահանակներ։",
    ),
    image: img.product,
    parentId: "cat-panels",
    productCount: 12,
