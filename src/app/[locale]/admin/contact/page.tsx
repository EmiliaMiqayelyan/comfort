      ...
      <AdminShell>
        ...
        <Section title={t("contactRequests")}>
          <div className="space-y-3">
            {messages.length === 0 && <p className="text-sm text-zinc-500">{t("noResults")}</p>}
            {messages.map((message) => (
              <article
                key={message.id}
                className="rounded-2xl border border-white/10 bg-[#141a24] p-4 text-sm text-zinc-200"
              >
                ...
                <p className="mt-3 whitespace-pre-wrap text-zinc-300">{message.message}</p>
              </article>
            ))}
          </div>
        </Section>
          ...
          <Section title={t("contactDetails")}>
            ...
            <Field label={t("socials")}>
              <Textarea
                ...
                className={adminFieldClass}
              />
              <p className="mt-2 text-xs text-zinc-500">{t("socialsHint")}</p>
            </Field>
            <Field label={t("showrooms")}>
              <Textarea
                ...
                className={adminFieldClass}
              />
              <p className="mt-2 text-xs text-zinc-500">{t("showroomsHint")}</p>
            </Field>
